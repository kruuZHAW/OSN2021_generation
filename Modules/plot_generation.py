...
plot_turns(spline_x, spline_y, "Real", i, threshold = threshold)
...
plot_turns(spline_x, spline_y, "Vines_samp", i, threshold = threshold)
...
plot_turns(spline_x, spline_y, "Gm_samp", i, threshold = threshold)
...
plot_turns(spline_x, spline_y, "Mvn_samp", i, threshold = threshold)
